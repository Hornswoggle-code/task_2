...
def read_files():
    no_promotion = dd.read_csv('final_data/transactions_no_promotion.csv/*', blocksize='4MB')
    no_promotion['TransactionDate'] = dd.to_datetime(no_promotion['TransactionDate'])
    with_promotion = dd.read_csv('final_data/transactions_with_promotion.csv/*', blocksize='4MB')
